...
N> 6. Starting with v17.1.0.x, if you reference Syncfusion assemblies from the NuGet feed, you also have to add "Syncfusion.SkiaSharpHelper" assembly reference in your projects.
