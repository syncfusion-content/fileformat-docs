---
title: Convert Word document to Image in Azure App Service on Linux | Syncfusion
description: Convert Word document to Image in Azure App Service on Linux using .NET Core Word (DocIO) library without Microsoft Word or interop dependencies.
