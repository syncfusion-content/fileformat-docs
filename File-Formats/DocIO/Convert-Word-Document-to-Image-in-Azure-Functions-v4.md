...
Step 5: Add the following code snippet in **Run** method of **Function1** class to perform **convert Word to Image** in Azure Functions and return the resultant **Image** to client end.
