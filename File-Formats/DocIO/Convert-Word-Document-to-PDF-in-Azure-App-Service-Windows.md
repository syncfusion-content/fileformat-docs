...
Step 3: Step 3: Install the following **Nuget packages**.
...
NuGet package as a reference to your .NET Core application from NuGet.org.
 ...
 ![Install SkiaSharp.NativeAssets.Win32 Nuget Package](Azure_Images/App_Service_Windows/SkiaSharp_Nuget-Package_WordtoPDF.png)
...
![Select the publish target](Azure_Images/App_Service_Windows/Specfic_Target_WordtoPDF.png)
