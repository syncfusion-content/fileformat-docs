...
Step 3: You can ensure Docker and app.yaml file are added in **Workspace**.
![Add required files to publish folder](GCP_Images/Libfontconfig-WordtoPDF.png)

## Deploy to App Engine

Step 1: Run the following command in Cloud Shell to Deploy the application to cloud service.Afterwards get **link** from the **Cloud Shell Editor**.
...
Step 2: The application is now deployed successfully.
