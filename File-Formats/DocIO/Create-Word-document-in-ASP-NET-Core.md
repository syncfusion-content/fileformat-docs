...
![Create ASP.NET Core Web application in Visual Studio](asp-net-core_images/create-word-document-in-aspnet-core-web-application.png)

Step 2: Select Web Application pattern (Model-View-Controller) for the project.

![Select ASP.NET Core Web Application pattern](asp-net-core_images/create-word-document-in-aspnet-core-select-web-application.png)
...
![Install ASP.NET Core NuGet package](asp-net-core_images/create-word-document-in-aspnet-core-install-nuget-packages.png)
...
![ASP.Net Core output Word document](asp-net-core_images/create-word-document-in-aspnet-core-getting-started-output.jpg)