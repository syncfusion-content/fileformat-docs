...
![Create .NET Core console application on File-Format DOcIO Linux](linux_images/file-format-docio-linux-console-application.png)
...
![Install NuGet packages in Linux File Format DOcIo](linux_images/file-format-docio-linux-install-nuget-packages.png)
...
![Restore the NuGet packages in Linux File Format DOcIO](linux_images/file-format-docio-linux-restore-packages.png)
...
![Run the Applcation in Linux File Format DOcIO](linux_images/file-format-docio-linux-run-application.png)
...
![Word document generated on File Format DOcIO Linux](linux_images/file-format-docio-linux-getting-started-output.jpg)