...
<table>
  ...
  <tr>
  <td>
    {{'[.NET MAUI Project](https://github.com/SyncfusionExamples/DocIO-Examples/tree/main/Getting-Started/.NET-MAUI)'| markdownify }}
  </td>
  <td>
  ...
  <tr>
  <td>
    {{'[Windows](https://github.com/SyncfusionExamples/DocIO-Examples/tree/main/Getting-Started/.NET-MAUI/Create-Word-document/Platforms/Windows)'| markdownify }}
  </td>
  <td>
  ...
  <tr>
  <td>
    {{'[Android](https://github.com/SyncfusionExamples/DocIO-Examples/tree/main/Getting-Started/.NET-MAUI/Create-Word-document/Platforms/Android)'| markdownify }}
  </td>
  <td>
  ...
  <tr>
  <td>
    {{'[Mac Catalyst](https://github.com/SyncfusionExamples/DocIO-Examples/tree/main/Getting-Started/.NET-MAUI/Create-Word-document/Platforms/MacCatalyst)'| markdownify }}
  </td>
  <td>
  ...
  <tr>
  <td rowspan="2">
    {{'[iOS](https://github.com/SyncfusionExamples/DocIO-Examples/tree/main/Getting-Started/.NET-MAUI/Create-Word-document/Platforms/iOS)'| markdownify }}
  </td>
  <td>
