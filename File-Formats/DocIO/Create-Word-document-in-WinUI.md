...
![Create the WinUI Desktop app in File Formats DOCIO Visual Studio](winui_images/file-formats-docio-create-desktop-project.png)

Step 2: Enter the project name and click **Create**.

![Create a project name for your new project in File Formats DOCIO](winui_images/file-formats-docio-create-project-name.png)
...
![Set the target version in File Formats DOCIO](winui_images/file-formats-docio-target-version.png)
...
![Install the DocIO .NET NuGet package in File Formats](winui_images/file-formats-docio-install-nuget.png)
...
![WinUI Desktop output in File Formats Word document](winui_images/file-formats-docio-gettingstarted-output.jpg)

## WinUI UWP app

Step 1: Create a new C# WinUI UWP app. Select Blank App (WinUI 3 in UWP)from the template and **click** the Next button.

![Create the WinUI UWP app in File Formats DOCIO Visual Studio](winui_images/file-formats-docio-create-uwp-project.png)
...
![Create a project name for your new project in File Formats DOCIO](winui_images/file-formats-docio-create-uwp-project-name.png)

Step 3: Set the Target version to Windows 10, version 2004 (build 19041) and the Minimum version to Windows 10, version 1809 (build 17763) and then click **OK**.

![Set the target version in File Formats DOCIO](winui_images/file-formats-docio-uwp-target-version.png)

Step 4: Install the Syncfusion.DocIO.NET NuGet package as a reference to your project from the [NuGet.org](https://www.nuget.org/).

![Install the DocIO .NET NuGet package in File Formats](winui_images/file-formats-docio-uwp-install-nuget.png)
...
![WinUI UWP output Word document](winui_images/file-formats-uwp-gettingstarted-output.jpg)
