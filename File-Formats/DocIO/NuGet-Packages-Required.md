...
N> 4. From v20.1.0.x, the dependent package SkiaSharp is upgraded from 2.80.2 to 2.88.0-preview.209 version and it is mandatory to use SkiaSharp.NativeAssets.Linux v2.88.0-preview.209 package for converting Word documents into PDF in Linux environment.
