...
![Click the Create button](Azure_Images/App_Service_Linux/Hosting-Open-and-Save-Word-Document.png)

Step 7: Click the **Finish** button to finalize the **App Service** creation.
![Click the Finish button](Azure_Images/App_Service_Linux/Finish-Open-and-Save-Word-Document.png)

Step 8: Click **Close** button.
![Create a ASP.NET Core Project](Azure_Images/App_Service_Linux/Publish-Open-and-Save-Word-Document.png)

Step 9: Click the **Publish** button.
![Click the Publish button](Azure_Images/App_Service_Linux/Before-Publish-Open-and-Save-Word-Document.png)

Step 10: Now, Publish has been succeeded.
![Publish has been succeeded](Azure_Images/App_Service_Linux/After-Publish-Open-and-Save-Word-Document.png)
