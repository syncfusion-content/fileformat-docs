...
![Output document after applied Number format for SEQ field](workingwithfields_images/file-formats-docio-seqlfield-numberformat-output.png)
...
![Output document of Bookmark referred in SEQ field](workingwithfields_images/file-formats-docio-seqlfield-bookmark-output.png)
...
![Output of reset numbering in SEQ field](workingwithfields_images/file-formats-docio-seqlfield-resetnumbering-output.png)
...
![Output of repeating Nearest number of SEQ field](workingwithfields_images/file-formats-docio-seqlfield-repeatnearestnumber-output.png)
...
![Output after hiding the sequence field](workingwithfields_images/file-formats-docio-seqlfield-hide-output.png)
