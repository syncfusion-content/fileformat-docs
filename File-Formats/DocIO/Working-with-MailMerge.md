...
Private Shared Sub BeforeClearFields(ByVal sender As Object, ByVal args As BeforeClearGroupFieldEventArgs)

If Not args.HasMappedGroupInDataSource Then

uDim groupName As String() = args.GroupName.Split(":"c)
