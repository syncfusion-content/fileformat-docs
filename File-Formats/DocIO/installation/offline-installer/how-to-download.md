...
# Downloading Syncfusion Word offline installer
...
6. Click the More Download Options (element 2 in the above screenshot) button to get the Essential Studio Word Offline trial installer which is available in EXE and ZIP format.
...
You can also refer to the [**Offline installer**](https://help.syncfusion.com/Word/installation/offline-installer/how-to-install) links for step-by-step installation guidelines.	