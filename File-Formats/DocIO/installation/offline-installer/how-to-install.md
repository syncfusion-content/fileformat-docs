---
layout: post
title: Installing Syncfusion Word offline installer-Syncfusion
...
# Installing Syncfusion Word offline installer
...
2.	To unlock the Syncfusion offline installer, you have two options:
    ...
    **Use Unlock Key**
    ...
    Unlock keys are used to unlock the Syncfusion offline installer, and they are platform and version specific. You should use either Syncfusion licensed or trial Unlock key to unlock Syncfusion Word installer.
...
1.	Run the Syncfusion Word installer by double-clicking it. The Installer Wizard automatically opens and extracts the package.
...
Syncfusion Essential Word can be uninstalled silently using the Command Line.
