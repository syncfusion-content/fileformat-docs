...
![Word document template for nested groups](../mailmerge_images/file-formats-docio-nested-group-mail-merge-template.png)
...
![Nested group mail merged document](../mailmerge_images/file-formats-docio-nested-group-mail-merge-output.png)
...
![Word document template to map the fields of ancestor group](../mailmerge_images/file-formats-docio-mail-merge-with-implicit-relation-template.png)
...
![Output Word document of mapping field of ancestor group](../mailmerge_images/file-formats-docio-mail-merge-with-implicit-relation-output.png)
