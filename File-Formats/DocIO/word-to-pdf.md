...
In Linux OS, you can perform the Word to PDF conversion using .NET Core application. You can refer [here](https://help.syncfusion.com/file-formats/docio/assemblies-required#converting-word-document-to-pdf) to know about the packages required to deploy .NET Core application with Word to PDF conversion capabilities in Linux OS.
