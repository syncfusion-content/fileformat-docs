...
In Linux OS, we can perform the Word document to PDF conversion using .NET Core application. To deploy .NET Core application with Word to PDF conversion capabilities in Linux OS, the following NuGet packages needs to be referred in your .NET Core application.
...
# Download libSkiaSharp.so from [here](https://github.com/mono/SkiaSharp/releases/tag/v1.59.3#).
