...
From v18.4, in addition to the previous NuGet packages, we recommend to use SkiaSharp.NativeAssets.Linux v2.80.2 NuGet from [here](https://www.nuget.org/packages/SkiaSharp.NativeAssets.Linux/2.80.2) to perform Word to PDF conversion in Linux environment.
...
<td>
Only Single, Dotted, Dash, DotDash and DotDotDash underline styles are supported.
</td>
</tr>
<tr>
<td>
