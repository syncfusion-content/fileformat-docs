...
<img src="htmlconversion_images/AzureNetCore.png" alt="Convert HTMLToPDF Azure NetCore Step1" width="100%" Height="Auto"/> 
...
* Create a shell file with the below commands in the project and name it as dependenciesInstall.sh. In this article, these steps have been followed to install dependencies packages.
