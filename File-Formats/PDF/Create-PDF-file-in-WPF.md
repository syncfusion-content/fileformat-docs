...
![Creation1](WPF_images/Creation1.jpeg)

Install the [Syncfusion.Pdf.Wpf](https://www.nuget.org/packages/Syncfusion.Pdf.Wpf/ ) NuGet package as reference to your .NET Framework applications from [NuGet.org](https://www.nuget.org/ ).
![Creation1](WPF_images/Creation2.jpeg)
...
![WPF PDF Generation output](GettingStarted_images/pdf-generation-output.jpg)
