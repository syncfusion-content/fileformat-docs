...
You can add the JavaScript action to the PDF document by using the following code sample. 
...
You can add the JavaScript actions to various form fields using ```PdfJavaScriptAction``` instance. The ```PdfFieldAction``` class is used to create form field actions. 
