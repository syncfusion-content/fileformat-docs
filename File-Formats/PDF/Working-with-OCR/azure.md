...
description: Learn how to perform OCR on scanned PDF documents and images with different tesseract version in Azure using Syncfusion .NET OCR library.
...
The Syncfusion .NET OCR library used to extract text from scanned PDFs and images in Azure with the help of Google's [Tesseract](https://github.com/tesseract-ocr/tesseract) Optical Character Recognition engine.
...
Step 7: Include the following namespaces.
...
Step 8: Add the code samples for performing OCR for a PDF document in Azure.
...
Step 6: Include the following namespaces in Function1.cs file to perform OCR for a PDF document using C#.
...
Step 7: Add the following code snippet in the Function1 class to perform OCR for a PDF document in Azure Functions.
