...
You can change the tab order of form fields by assigning required order to the [FormFieldsTabOrder](https://help.syncfusion.com/cr/file-formats/Syncfusion.Pdf.Base~Syncfusion.Pdf.PdfPageBase~FormFieldsTabOrder.html) property available under [PdfPageBase](https://help.syncfusion.com/cr/file-formats/Syncfusion.Pdf.Base~Syncfusion.Pdf.PdfPageBase.html), using [PdfFormFieldsTabOrder](https://help.syncfusion.com/cr/file-formats/Syncfusion.Pdf.Base~Syncfusion.Pdf.PdfFormFieldsTabOrder.html) Enum.

The following code snippet explains how to set ``Manual`` tab order for the form fields in a new PDF document.
...
//Set the tab order for form fields as Manual
...
textBox1.Bounds = new RectangleF(0, 0, 150, 30);
document.Form.Fields.Add(textBox1);

//Add the second text box
PdfTextBoxField textBox2 = new PdfTextBoxField(page, "TextBox2");
textBox2.Bounds = new RectangleF(200, 0, 150, 30);
document.Form.Fields.Add(textBox2);

//Add the third text box
PdfTextBoxField textBox3 = new PdfTextBoxField(page, "TextBox3");
textBox3.Bounds = new RectangleF(0, 100, 150, 30);
document.Form.Fields.Add(textBox3);

//Add the fourth text box
PdfTextBoxField textBox4 = new PdfTextBoxField(page, "TextBox4");
textBox4.Bounds = new RectangleF(200, 100, 150, 30);
document.Form.Fields.Add(textBox4);

//Set the tab index for text box fields
textBox1.TabIndex = 1;
textBox2.TabIndex = 0;
textBox3.TabIndex = 2;
textBox4.TabIndex = 3;
...
'Add the first text box 
Dim textBox1 As PdfTextBoxField = New PdfTextBoxField(page, "TextBox1")
textBox1.Bounds = New RectangleF(0, 0, 150, 30)
document.Form.Fields.Add(textBox1)

'Add the second text box
Dim textBox2 As PdfTextBoxField = New PdfTextBoxField(page, "TextBox2")
textBox2.Bounds = New RectangleF(200, 0, 150, 30)
document.Form.Fields.Add(textBox2)

'Add the third text box
Dim textBox3 As PdfTextBoxField = New PdfTextBoxField(page, "TextBox3")
textBox3.Bounds = New RectangleF(0, 100, 150, 30)
document.Form.Fields.Add(textBox3)

'Add the fourth text box
Dim textBox4 As PdfTextBoxField = New PdfTextBoxField(page, "TextBox4")
textBox4.Bounds = New RectangleF(200, 100, 150, 30)
document.Form.Fields.Add(textBox4)
...
The following code snippet explains how to set ``Manual`` tab order for the form fields in an existing PDF document.

{% tabs %}
{% highlight C# %}
//Load an existing PDF document
PdfLoadedDocument loadedDocument = new PdfLoadedDocument("PdfDocument.pdf");

//Get the page from loaded document into PdfLoadedPage
PdfLoadedPage loadedPage = loadedDocument.Pages[0] as PdfLoadedPage;

//Set the tab order for form fields as Manual
loadedPage.FormFieldsTabOrder = PdfFormFieldsTabOrder.Manual;

//Get the form fields in loaded document into collection
PdfLoadedFormFieldCollection fields = loadedDocument.Form.Fields;

//Set the tab index for form fields
(fields[0] as PdfLoadedTextBoxField).TabIndex = 1;
(fields[1] as PdfLoadedTextBoxField).TabIndex = 0;
(fields[2] as PdfLoadedTextBoxField).TabIndex = 2;
(fields[3] as PdfLoadedTextBoxField).TabIndex = 3;
...
{% highlight vb.net %}
'Load an existing PDF document
Dim loadedDocument As PdfLoadedDocument = New PdfLoadedDocument("PdfDocument.pdf")
...
'Get the form fields in loaded document into collection
Dim fields As PdfLoadedFormFieldCollection = loadedDocument.Form.Fields

'Set the tab index for form fields
CType(fields(0), PdfLoadedTextBoxField).TabIndex = 1
CType(fields(1), PdfLoadedTextBoxField).TabIndex = 0
CType(fields(2), PdfLoadedTextBoxField).TabIndex = 2
CType(fields(3), PdfLoadedTextBoxField).TabIndex = 3
...
{% highlight UWP %}
//Load an existing PDF document
Stream documentStream = typeof(MainPage).GetTypeInfo().Assembly.GetManifestResourceStream("Sample.Assets.PdfDocument.pdf");
...
{% highlight ASP.NET Core %}
//Load an existing PDF document
FileStream documentStream = new FileStream("PdfDocument.pdf", FileMode.Open);
PdfLoadedDocument loadedDocument = new PdfLoadedDocument(documentStream);
