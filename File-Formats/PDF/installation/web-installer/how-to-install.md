...
# Installing Syncfusion PDF web installer


## Overview

For the Essential Studio PDF product, Syncfusion offers a Web Installer. This installer alleviates the burden of downloading a larger installer. You can simply download and run the online installer, which will be smaller in size and will download and install the Essential Studio products you have chosen. You can get the most recent version of Essential Studio Web Installer [here](https://www.syncfusion.com/downloads/latest-version). 

 
## Installation

The steps below show how to install Essential Studio PDF Web Installer.

1.  Open the Syncfusion Essential Studio PDF Web Installer file from downloaded location by double-clicking it. The Installer Wizard automatically opens and extracts the package.
...
2. 	The Syncfusion PDF Web Installer's welcome wizard will be displayed. Click the Next button.
...
Syncfusion PDF installer can be uninstalled in two ways.

   * Uninstall the PDF using the Syncfusion PDF web installer
   * Uninstall the PDF from Windows Control Panel

Follow either one of the option below to uninstall Syncfusion Essential Studio PDF installer.
  
**Option 1: Uninstall the PDF using the Syncfusion PDF web installer**
...
You can uninstall all the installed products by selecting the **Syncfusion Essential Studio {version}** entry (element 1 in the below screenshot) from the Windows control panel, or you can uninstall PDF alone by selecting the **Syncfusion Essential Studio for PDF {version}** entry (element 2 in the below screenshot) from the Windows control panel.

![Control Panel](images/Step-by-Step-Installation_img22.png)
	
N> If the **Syncfusion Essential Studio for PDF {version}** entry is selected from the Windows control panel, the Syncfusion Essential Studio PDF alone will be removed and the below default MSI uninstallation window will be displayed.	

1.  The Syncfusion PDF Web Installer's welcome wizard will be displayed. Click the Next button
