...
Step 7: Add the below code snippet in in **HomeController.cs** to **convert a PowerPoint to image in ASP.NET MVC**.
...
![Converted Image from PowerPoint in ASP.NET MVC](PPTXtoPDF_images/Output_PowerPoint_Presentation_to-Image.png)
