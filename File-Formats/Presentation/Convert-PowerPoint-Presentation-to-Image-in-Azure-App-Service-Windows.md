...
description: Convert PPTX to image in Azure App Service on Windows using PowerPoint library (Presentation) without Microsoft PowerPoint or interop dependencies.
