---
title: Convert PPTX to Image in Google App Engine | Syncfusion
...
![Create ASP.NET Core Web application in Visual Studio](GCP_Images/Configure-PowerPoint-Presentation-to-Image.png)
