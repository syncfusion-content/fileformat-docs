...
By executing the program, you will get the **image** as follows. The output will be saved in the **bin** folder file.

![Converted image from PowerPoint in Linux](PPTXtoPDF_images/Output_PowerPoint_Presentation_to-Image.png)
