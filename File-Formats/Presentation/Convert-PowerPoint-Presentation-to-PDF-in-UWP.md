...
Step 5: Include the below code snippet in the click event of the button in MainPage.xaml.cs, to **convert a PowerPoint to PDF in UWP**.

{% tabs %}
{% highlight c# tabtitle="C#" %}

//Load an existing PowerPoint document.
