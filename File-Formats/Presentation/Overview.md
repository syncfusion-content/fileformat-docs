...
description: Essential Presentation is a .NET PowerPoint library to create, edit, & convert PowerPoint files in WinForms, WPF, UWP, ASP.NET Core & Xamarin applications
