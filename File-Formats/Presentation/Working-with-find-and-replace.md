...
You can find all occurrences of a pattern of text in a PowerPoint presentation using the FindAll method and replace it with other text.
 
The following code example illustrates how to find all occurrences of a pattern of text and replace it with other text in a PowerPoint presentation using Regex pattern.
...
using (FileStream inputStream = new(Path.GetFullPath("Sample.pptx"), FileMode.Open, FileAccess.Read, FileShare.ReadWrite))
{
    //Open an existing PowerPoint presentation.
    using (IPresentation pptxDoc = Presentation.Open(inputStream))
    {
        //Find all the occurrences of a particular pattern text in the PowerPoint presentation using Regex.
...
Using(pptxDoc As IPresentation = Presentation.Open("Sample.pptx"))
{
    'Finds all the occurrences of a particular pattern text in the PowerPoint presentation
