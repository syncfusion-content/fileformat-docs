...
description: ASP.NET MVC PowerPoint library to create, read, edit and convert PowerPoint files in ASP.NET MVC applications. Supports text, shape, chart, table and combine PowerPoints.
