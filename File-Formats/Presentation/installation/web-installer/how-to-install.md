---
layout: post
title: Installing Syncfusion PowerPoint web installer - Syncfusion
description: Learn here about how to install Syncfusion PowerPoint web installer after downloading from our Syncfusion website.
platform: PowerPoint
control: Installation and Deployment
documentation: ug
---

# Installing Syncfusion PowerPoint web installer


## Overview

For the Essential Studio PowerPoint product, Syncfusion offers a Web Installer. This installer alleviates the burden of downloading a larger installer. You can simply download and run the online installer, which will be smaller in size and will download and install the Essential Studio products you have chosen. You can get the most recent version of Essential Studio Web Installer [here](https://www.syncfusion.com/downloads/latest-version). 

 
## Installation

The steps below show how to install Essential Studio PowerPoint Web Installer.

1.  Open the Syncfusion Essential Studio PowerPoint Web Installer file from downloaded location by double-clicking it. The Installer Wizard automatically opens and extracts the package.
...
2. 	The Syncfusion PowerPoint Web Installer's welcome wizard will be displayed. Click the Next button.
...
Syncfusion PowerPoint installer can be uninstalled in two ways.

   * Uninstall the PowerPoint using the Syncfusion PowerPoint web installer
   * Uninstall the PowerPoint from Windows Control Panel

Follow either one of the option below to uninstall Syncfusion Essential Studio PowerPoint installer.
  
**Option 1: Uninstall the PowerPoint using the Syncfusion PowerPoint web installer**
...
You can uninstall all the installed products by selecting the **Syncfusion Essential Studio {version}** entry (element 1 in the below screenshot) from the Windows control panel, or you can uninstall PowerPoint alone by selecting the **Syncfusion Essential Studio for PowerPoint {version}** entry (element 2 in the below screenshot) from the Windows control panel.

![Control Panel](images/Step-by-Step-Installation_img22.png)
	
N> If the **Syncfusion Essential Studio for PowerPoint {version}** entry is selected from the Windows control panel, the Syncfusion Essential Studio PowerPoint alone will be removed and the below default MSI uninstallation window will be displayed.	

1.  The Syncfusion PowerPoint Web Installer's welcome wizard will be displayed. Click the Next button
