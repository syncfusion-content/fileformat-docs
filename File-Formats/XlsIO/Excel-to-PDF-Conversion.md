---
title: Excel to PDF Conversion | Synncfusion
...
![Input excel file in File Formats.](excel-to-pdf-conversion_images/file-formats-input-excel-file.png)

The following screenshot represents the output pdf file generated by the XlsIO using **PrintInPlace** option

![Output pdf file in File Formats.](excel-to-pdf-conversion_images/file-formats-output-pdf-file.png)
...
![Input excel file convert commented sheets in File Formats.](excel-to-pdf-conversion_images/file-formats-input-excel-file-convert-commented-sheets.png)

The following screenshot represents the output pdf file generated by the XlsIO using **PrintSheetEnd** option

![Output pdf file genereted in File Formats.](excel-to-pdf-conversion_images/file-formats-output-pdf-file-generated.png)
![Output pdf file print sheet end option in File Formats.](excel-to-pdf-conversion_images/file-formats-output-pdf-file-print-sheet-end-option.png)
...
![Input excel file convert without comments in File Formats.](excel-to-pdf-conversion_images/file-formats-input-excel-file-convert-without-comments.png)

The following screenshot represents the output pdf file generated by the XlsIO using **PrintNoComments** option

![Output pdf file using convert without comments in File Formats.](excel-to-pdf-conversion_images/file-formats-output-pdf-file-convert-without-comments.png)
...
![Input excel file with threaded comments in file formats.](excel-to-pdf-conversion_images/file-formats-input-excel-file-with-threaded-comments.png)

The following screenshot represents the output pdf document generated by the XlsIO using **PrintSheetEnd** option

![Output pdf file with threaded comments in file formats.](excel-to-pdf-conversion_images/file-formats-output-pdf-with-threaded-comments.png)
...
![Printer settings in File Formats.](excel-to-pdf-conversion_images/file-formats-printer-setting.jpg)
