...
Threaded comments will be rendered in the PDF document at the end of the each sheet which contains comments, when the **PrintSheetEnd** option is selected. The following code illustrates how to set print options to convert threaded comments.
