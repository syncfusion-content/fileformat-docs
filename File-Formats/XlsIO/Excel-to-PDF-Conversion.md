...
By default,XlsIO prints the notes as mentioned in the Excel file.However, you may want to change the printing location of the notes during conversion. XlsIO supports to change the printing location of the notes using ExcelPrintLocation Enum.
XlsIO provides three ways to print the notes. They are:
**PrintInPlace**
**PrintSheetEnd**
**PrintNoComments**
These are maintained under the **ExcelPrintLocation** enumeration.

### PrintInPlace
Notes will be rendered in the output PDF document as displayed in the Excel file, when the **PrintInPlace** option is selected.
...
### PrintSheetEnd
Notes will be rendered in the output PDF document at the end of the each sheet which contains the notes, when the **PrintSheetEnd** option is selected.
...
### PrintNoComments
Notes are not  displayed in the output PDF document, when the **PrintNoComments** option is selected.
