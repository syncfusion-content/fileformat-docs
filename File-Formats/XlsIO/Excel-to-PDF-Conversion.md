...
XlsIO supports to convert a workbook or a worksheet with threaded comments to PDF documents. To convert the threaded comments in worksheets of an Excel workbook, it is a must to set the print options through [ExcelPrintLocation](https://help.syncfusion.com/cr/file-formats/Syncfusion.XlsIO.ExcelPrintLocation.html) enumeration.

### Convert threaded comments at the end of the sheet

Threaded Comments will be rendered in the output PDF document at the end of the each sheet which contains the threaded comments, when the **PrintSheetEnd** option is selected. The following code illustrates this.
...
The following screenshot represents the output pdf file generated by the XlsIO using **PrintSheetEnd** option
<img src="Excel-to-PDF-Conversion_images/Excel-to-PDF-Conversion_img9.png" alt="output pdf file" width="100%" Height="Auto"/>

<img src="Excel-to-PDF-Conversion_images/Excel-to-PDF-Conversion_img10.png" alt="output pdf file" width="100%" Height="Auto"/>
