...
## Excel with Notes to PDF

XlsIO allows you to convert a workbook/worksheet with notes into PDF document.
By default,XlsIO prints the notes as mentioned in the Excel file.However, you may want to change the printing location of the notes during conversion. XlsIO supports to change the printing location of the notes using ExcelPrinLocation Enum.
XlsIO provides three ways to print the notes. They are:
**PrintInPlace**
**PrintSheetEnd**
**PrintNoComments**

The following code illustrates how to convert an Excel with notes to PDF document using PrintInPlace option
...
![input excel file](Excel-to-PDF-Conversion_images/Excel-to-PDF-Conversion_img2.jpg)

The following screenshot represents the output pdf file generated by the XlsIO
![output pdf file](Excel-to-PDF-Conversion_images/Excel-to-PDF-Conversion_img3.jpg)

The following code illustrates how to convert an Excel with notes to PDF document using PrintSheetEnd option
...
The following screenshot represents the input Excel file with notes
![input excel file](Excel-to-PDF-Conversion_images/Excel-to-PDF-Conversion_img4.jpg)

The following screenshot represents the output pdf file generated by the XlsIO
![output pdf file](Excel-to-PDF-Conversion_images/Excel-to-PDF-Conversion_img5.jpg)
![output pdf file](Excel-to-PDF-Conversion_images/Excel-to-PDF-Conversion_img.6jpg)

The following code illustrates how to convert an Excel with notes to PDF document using PrintNoComments option
...
The following screenshot represents the output pdf file generated by the XlsIO
![output pdf file](Excel-to-PDF-Conversion_images/Excel-to-PDF-Conversion_img7.jpg)
