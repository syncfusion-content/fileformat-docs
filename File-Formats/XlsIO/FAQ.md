...
* [How to resolve the performance issue when deleting a large number of rows?](faqs\how-to-resolve-the-performance-issue-when-deleting-a-large-number-of-rows)