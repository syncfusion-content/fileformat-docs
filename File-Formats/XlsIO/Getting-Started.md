...
if (Device.OS == TargetPlatform.WinPhone || Device.OS == TargetPlatform.Windows)
{
    Xamarin.Forms.DependencyService.Get<ISaveWindowsPhone>().Save("Spreadsheet.xlsx", "application/msexcel", stream);
}
else
{
    Xamarin.Forms.DependencyService.Get<ISave>().Save("Spreadsheet.xlsx", "application/msexcel", stream);
}
{% endhighlight %}
{% endtabs %}  
...
if (Device.OS == TargetPlatform.WinPhone || Device.OS == TargetPlatform.Windows)
{
    Xamarin.Forms.DependencyService.Get<ISaveWindowsPhone>().Save("TemplateMarkerResult.xlsx", "application/msexcel", stream);
}
else
{
    Xamarin.Forms.DependencyService.Get<ISave>().Save("TemplateMarkerResult.xlsx", "application/msexcel", stream);
}
{% endhighlight %}
{% endtabs %}  
