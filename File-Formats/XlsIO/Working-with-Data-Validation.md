...
{
	Xamarin.Forms.DependencyService.Get<ISaveWindowsPhone>().Save("DataValidation.xlsx", "application/msexcel", stream);
}
else
{
	Xamarin.Forms.DependencyService.Get<ISave>().Save("DataValidation.xlsx", "application/msexcel", stream);
}
{% endhighlight %}
{% endtabs %}  
