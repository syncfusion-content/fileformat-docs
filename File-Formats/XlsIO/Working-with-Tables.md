...
IListObject is a collection of columns, whereas a single column is represented by an instance of **IListObjectColmn**. XlsIO provides support to to insert or remove columns in a table through worksheet, as below.
