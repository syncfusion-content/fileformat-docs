...
You can paste a range as link to another range using CopyTo method.

Following code example illustrates how to paste a range of cells as link in destination from source.
