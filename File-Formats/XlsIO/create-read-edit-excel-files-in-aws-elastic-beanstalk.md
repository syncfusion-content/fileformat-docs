...
![Create ASP.NET Core Web application in Visual Studio](AWS_Images/Elastic_Beanstalk_Images/CreateProject.png)
...
![Install Syncfusion.XlsIO.Net.Core NuGet package](AWS_Images/Elastic_Beanstalk_Images/Install_Nuget_Create_Excel.png)
...
![Right-click the project and select the Publish option](AWS_Images/Elastic_Beanstalk_Images/Publish_Create_Excel.png)

Step 2: Select the **Deployment Target** as **Create a new application environment** and click **Next** button.
![Deployment Target in AWS Ealastic Beanstalk](AWS_Images/Elastic_Beanstalk_Images/Deployment_Target_Create_Excel.png)
...
![Application Environment in AWS Elastic Beanstalk](AWS_Images/Elastic_Beanstalk_Images/URL_Availability_Create_Excel.png)

Step 4: Select the instance type in **t3a.micro** from the dropdown list and click next.
![Application Environment in AWS Elastic Beanstalk](AWS_Images/Elastic_Beanstalk_Images/Launch_Configuration_Create_Excel.png)

Step 5: Click the **Next** button to proceed further.
![Application Environment in AWS Elastic Beanstalk](AWS_Images/Elastic_Beanstalk_Images/Permissions_Create_Excel.png)

Step 6: Click the **Next** button.
![Application Options in AWS Elastic Beanstalk](AWS_Images/Elastic_Beanstalk_Images/Application_Options_Create_Excel.png)

Step 7: Click the **Deploy** button to deploy the sample on
AWS Elastic Beanstalk.
![Deploy the sample in AWS Elastic Beanstalk](AWS_Images/Elastic_Beanstalk_Images/Review_Create_Excel.png)

Step 8: After changing the status from **Updating** to **Environment is healthy**, click the **URL**.
![Status check in AWS Elastic Beanstalk](AWS_Images/Elastic_Beanstalk_Images/Status_Create_Excel.png)

Step 9: After opening the provided **URL**, click **Create Document** button to download the Excel document.
![Click button to Create an Excel document](AWS_Images/Elastic_Beanstalk_Images/Browser_Create_Excel.png)

A complete working example of how to create an Excel file in AWS Elastic Beanstalk is present on [this GitHub page](https://github.com/SyncfusionExamples/XlsIO-Examples/tree/master/Getting%20Started/ASP.NET%20Core/Create%20Excel).

By executing the program, you will get the **Excel document** as follows.

![Create Excel in AWS Elastic Beanstalk](AWS_Images/Elastic_Beanstalk_Images/CreateExcelOutput.png)
...
A complete working example of how to read and edit an Excel file in AWS Elastic Beanstalk in C# is present on [this GitHub page](https://github.com/SyncfusionExamples/XlsIO-Examples/tree/master/Getting%20Started/ASP.NET%20Core/Edit%20Excel).
