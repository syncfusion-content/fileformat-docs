---
title: XlsIO supports in .NET 6.0 platform to create, edit and convert Excel documents. | Syncfusion
...
# Does XlsIO provide support for .NET 6.0 Platform?
Yes. XlsIO supports in .NET 6.0 platform to create, edit and convert Excel documents.
