...
2. Double-click the Syncfusion File Formats platform Setup file. The Setup Wizard opens and extracts the package automatically.

   ![](Platform_images/Step-by-Step-Installation_img1.png)

   N> The Setup wizard extracts the syncfusionessentialfileformats_(version).exe dialog, displaying the unzip operation of the package.
...
1. When you do not have the extracted setup (syncfusionessentialfileformats_(version).exe) then follow the steps from 2 to 7.
