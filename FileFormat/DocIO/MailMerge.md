...
The following code snippet provides supporting methods
...
The following code snippet shows how to bind the image from file system during mail merge process using MergeImageFieldEventHandler.
