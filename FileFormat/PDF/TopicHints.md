...
1. Adding assembly reference in an application (Compression.Base & Pdf.Base)
      a. Describe about the dependent assembly, namespace details required for using Essential PDF
2. Creating new instance for PDF document using Essential PDF.
3. Essential PDF has a set of APIs similar to the .NET GDI plus which helps to draw elements to the PDF page just like 2D drawing in .NET
...
5. In PDF, all the elements are placed in absolute positions and the layout result of each element provides the rendered bounds, which can be used to avoid content overlapping.
6. The Drawstring method of the page graphics helps to add the text to the page. The code snippet below adds the necessary text create a basic invoice application.

<<<Code for adding text>>

7. The DrawImage method helps to add image in a PDF page. Essential PDF supports a variety of scalar images such as bitmap, jpeg, gif, Tiff etc., and Metafile vector image.
...
Since the invoice document requires only a simple customization, the code snippet given below explains how to create a simple invoice table
...
* The DOM can be accessed and manipulated as needed to read and modify documents.

This object model can be used to manipulate the PDF document as needed
...
This sample illustrates how to create a PDF document with standard page size,
...
This sample illustrates how to create a PDF document with custom page size
...
3. You can also change orientation by setting the rotation angle using PdfPageRotateAngle Enum
<table>
<tr>
<td>
...
The following code snippet shows you how to set PDF document information.
...
The following code snippet shows you how to get PDF document information.
...
2. You can instruct the viewer to initially display the bookmarks, thumbnails or attachments using  PdfPageMode ENUM
<table>
<tr>
<td>
...
3. You can select the page layout to one column, single page, two column left, two column right using the PdfPageLayout ENUM
...
The following code sample explains you on how to add a page in a PDF document. The Add() method of the PdfPageCollection class adds the page at the end.
...
1) You can add text using the fonts installed in the system.

<<Code Snippet>>

2) You can add text using the font from local file system

<<Code Snippet>>

3) You can add text using the standard PDF fonts
...
Essential PDF allows you to add RTL text in the PDF document by using the RightToLeft property in the PdfStringFormat class, the following code snippet shows you how to add RTL text in the PDF document.
...
3) Complex HTML CSS will not support using this class.
...
You can insert the vector images into the PDF document using PdfMetafile class,
...
You can mask the images into the PDF document using PdfImageMask class
...
The following code snippet shows you how to replace an image in the existing PDF document.
...
The following code snippet demonstrates how to create the PdfLightTable :

<<code snippet>>

**Creating** **a** **simple** **table** **using** **PdfGrid** **model**

**PdfGrid** is based on cell model that offers rich API for formatting and layout options which can be used to enter the data manually or from an external data source.

The following code snippet demonstrates how to create the PdfGrid:
...
BackgroundImage is the image which is used to set the background image of the particular cell.
...
**PDF** document can contain any number of fields appearing on any combination of pages, all of that make a single, globally interactive form spanning the entire document
...
The extracted content will be in the order of how the text is encoded in the PDF document.

Please refer the below code snippet for basic text extraction. 

<<Code snippet>>

**Working** **with** **layout** **based** **text** **extraction**

The extracted content will be in the order of how it is viewed in the reader application.

Please refer the below code snippet for layout based text extraction
...
Essential PDF allows you to convert HTML page to PDF document. The converter has support for HTML5, CSS3, SVG, Web Fonts and JavaScript. This is done using two different rendering engines. They are
...
You can convert the http or https website to non-searchable PDF (bitmapped output) using the following the code snippet,
...
You can convert the http or https website to searchable PDF (vector) using the following code snippet,
...
You can convert the HTML string to PDF document, the following code snippet illustrate the same below,
...
You can convert the Windows Authenticated websites to PDF document by providing the username and password, the following code snippet explains the same below,
...
You can convert HTML page to PDF using WebKitHtmlConverter, refer the below code snippet.

<<Code snippet>>

**Converting** **the** **HTML** **string** **to** **PDF** **document**

You can convert HTML string to pdf using below code snippet

<<Code snippet>>

**Converting** **an** **SVG** **to** **PDF**

You can convert SVG files to PDF using below code snippet.
...
Please refer the below code snippet for conversion of Word document to PDF
...
The code snippet to illustrate the same is available below.
...
The code snippet to illustrate the conversion of RTF to PDF is given below.
...
You can convert HTML page to Images using HtmlConverter class, refer the below code snippet.

<<Code shippet>>

**Working** **with** **PDF** **to** **Image**

You can convert all Pages to Images of Pdf document using Essential PDF, refer the below code snippet
...
You can perform OCR on PDF document with the help of OCRProcessor and PdfLoadedDocument Class, refer the below code snippet.

<<Code snippet>>

**Performing** **OCR** **for** **a** **region** **of** **the** **document**

You can perform OCR on particular region of a PDF document with the help of PageRegion class, refer the below code snippet.
...
You can flow the table across multiple pages. The following code snippet illustrate how to flow the large content table on multiple pages,
...
You can draw the header and footer in PDF document using PdfPageTemplateElement class.

Please refer the procedure below to draw the header:

1) Create the template object for header using PdfPageTemplateElement class.
2) Assign the created header template into PDF document template at top.

The same procedure can be followed to draw the footer. The page numbers can be drawn in footer using automatic fields.

Please refer the below code snippet to draw the page numbers in footer using automatic fields:
...
<tr>
<td>
In order to add an annotation in a particular page, you need to add it to the PdfAnnotationCollection of that page using Add method. <br/><br/></td></tr>
</table>
...
External files can be hyperlinked in a pdf document using the file link annotation.
...
**Essential** **PDF** supports addition of timestamp in digital signatures. The date and time on which the document is signed can be added as part of the signature
...
You can add the action to the PDF document, refer the below code snippet
...
You can add text stamp in to the PDF document, please refer the below code snippet

<<Code snippet>>

**Adding** **Image** **Stamp** **into** **the** **PDF** **document**

You can add image as stamp into the PDF document, please refer the below code snipper.

<<Code snipper>>

**Watermarks**

You can add watermarks into the PDF document, please refer the below code snippet.
...
Please refer the below code snippet to overlay the documents.
...
**PdfPageLayer** used to create the layers in the **PdfDocument**, which allows creating unlimited levels of layers and sub-layers in a parent-child relationship, refer the below code snippet for adding multiple layers.
...
You can merge the multiple layers from an existing PDF document, refer the below code snippet.
...
Essential PDF allows you to compress the image in the PDF document to reduce the file size by change the image quality in the PdfBitmap class
